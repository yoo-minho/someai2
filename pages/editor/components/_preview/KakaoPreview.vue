...
<template>
  <div class="flex w-full p-3 gap-3" style="background-color: #9bbbd4; overflow-x: auto">
    <div>
      <UAvatar src="./avatar/ryan.png" alt="Avatar" size="md" img-class="rounded-lg object-cover" />
    </div>
    <div class="flex flex-col items-start">
      ...
      <div class="w-[400px] rounded-[8px]">
        ...
        <div class="px-3 py-2 tracking-[-.2px] leading-[24px] bg-white rounded-b-[8px]">
          ...
          <p class="text-[13px] text-ellipsis overflow-hidden whitespace-nowrap mt-[-4px]" style="color: #707070">
            {{ og.desc }}
          </p>
